...
AMATEUR_KEYWORDS = [
    ...
    'liga de reservas', 'division b', 'm-league', 'liga pro','u17',‘Eliteserien’, ‘NCAA’, ‘Costa Rican Women's Premier Division’, ‘Liga de Expansion MX, Apertura’, ‘II Lyga’, ‘Ettan, Norra’, ‘Pervaya Liga’, ‘Gozo Football League Second Division’
]
# -------------------------------
